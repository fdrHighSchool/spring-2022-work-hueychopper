public class ArrayResizer {
    ...
    public static int[][] resize(int[][] arr) {
        int[][] smaller = new int[2][arr[0].length]; //2 is row number because the original problem had a method which return 2 as the answer. the method would've gone in the place of 2.
        int ix = 0;
